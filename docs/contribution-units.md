...
This repository lands work on `main` from short-lived topic branches. It does not use GitHub Issues or Pull Requests.
...
- Paste a chat transcript as the message
- Add an AI co-author trailer
