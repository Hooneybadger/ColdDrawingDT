...
`MANIFEST.json` is a checksum list of public files in this contract set. It does not include local working notes.

Local-only working notes may exist under `docs/internal/`. That folder is not for the public Git history.
